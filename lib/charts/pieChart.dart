                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children:[ Row(
                              ...
                              children: [
                                ...
                                Text('Food',style: TextStyle(color: Color(0xff4F98A1),fontWeight: FontWeight.bold,))
                              ],
                            ),
                          ...
                          Row(
                            children: [
                              ...
                              Text('Clothing',style: TextStyle(color: Color(0xff4F98A1),fontWeight: FontWeight.bold,))
                            ],
                          ),
                          SizedBox(
                            height: 10,
                          ...
                          Row(
                            children: [
                              ...
                              Text('Transportation',style: TextStyle(color: Color(0xff4F98A1),fontWeight: FontWeight.bold,))
                            ],
                          )
                            ]
                          ),
